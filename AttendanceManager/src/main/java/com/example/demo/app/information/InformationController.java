...
public class InformationController {
    ...
    @GetMapping("/{id}")
    public String showUpdate(InformationForm informationForm,
            @PathVariable int id,
            Model model) {
    ...
    public String info_edit(InformationForm informationForm, Model model) {
        model.addAttribute("title", "日次勤怠編集画面");
        return "information/info_edit";
    }
    
    @PostMapping("/{id}")
    public String info_post(@Validated InformationForm informationForm,
    ...
    @PostMapping
    public String post(@Validated InformationForm informationForm,
            BindingResult result,
            @RequestParam int id,
            Model model,
            RedirectAttributes redirectAttributes) {
